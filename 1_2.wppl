...
var ComplexModel2 = function() {
    ...
    /*
    Ahogy a SimpleModelben is:
    A konklúzió akkor érvényes, ha az operátor 'és'-ként van értelmezve, illetve a két állítás megegyezik. 
    A különbség, hogy mit értelmezünk 'és'-ként és mit 'vagy'-ként.
    Ebben az esetben az 'és' 95%-ban, a 'vagy' 80%-ban értelmezett "és"-ként.
    */
